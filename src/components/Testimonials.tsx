...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Triplora made our dream trip to India absolutely magical. Every detail was perfectly planned, and our guide was incredibly knowledgeable. The Kerala backwaters were breathtaking!',
  ...
  return (
    <section className="py-20 px-2 bg-gray-50 dark:bg-gray-900">
